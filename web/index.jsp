<%-- 
    Document   : index
    Created on : Jun 8, 2012, 1:39:08 PM
    Author     : Rahul
--%>

<%@page import="scoop.util.Resource"%>
...
<html lang="en">
    ...
    <body>
        <div style="width:100%; height: 10%;"> SCOOP India</div>
		<header class="main-title">
			...
			<p><strong>Best viewed in a Webkit browser (Safari, Chrome)</strong></p>
                       ...
                       <jsp:useBean id="cp" scope="application" class="scoop.database.ConnectionParameters">
            <jsp:setProperty name="cp" property="url" value="${initParam['database.url']}" />
            <jsp:setProperty name="cp" property="db" value="${initParam['database.db']}" />
            <jsp:setProperty name="cp" property="driver" value="${initParam['database.driver']}" />
            <jsp:setProperty name="cp" property="username" value="${initParam['database.username']}" />
            <jsp:setProperty name="cp" property="props" value="${initParam['database.props']}" />
            <jsp:setProperty name="cp" property="password" value="" />
        </jsp:useBean>
                        <jsp:include page="parts/article.jsp">
                            <jsp:param name="article_id" value="1"></jsp:param>
                        </jsp:include>

                        <jsp:include page="parts/functions.jsp">
                            <jsp:param name="username" value="rahuldon74"></jsp:param>
                        </jsp:include>

                         <jsp:include page="parts/comments.jsp">
                            <jsp:param name="article_id" value="1"></jsp:param>
                        </jsp:include>
